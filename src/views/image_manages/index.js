...
class ImageItem extends React.Component {
  ...
  render() {
    ...
    let RenameContent = (
      <div>
        <Input placeholder="现在的名字" ref="image_name_edit"/>
        <Button type="primary" checked={imageItemValue} onClick={this.onClickReName.bind(this, imageItemName, data)}>确定</Button>
        <Button type="ghost" onClick={this.onClosePop.bind(this)}>取消</Button>
      </div>
    );
    //确认复制
    let selectAfter = (
      <Button type="primary" onClick={this.onClickCopy.bind(this)}>复制</Button>
    );
    //复制容器
    let LinkContent = (
      <Input value="当前的链接" disabled={true} addonAfter={selectAfter}/>
    );
    ...
    let MoveContent = (
      <div>
        ...
        <Button type="primary" onClick={this.onClickMove.bind(this)}>确定</Button>
        <Button type="ghost" onClick={this.onClosePop.bind(this)}>取消</Button>
      </div>
    );
    //删除容器
    let DeleteContent = (
      <div>
        ...
        <Button type="primary" onClick={this.onClickDelete.bind(this)}>确定</Button>
        <Button type="ghost" onClick={this.onClosePop.bind(this)}>取消</Button>
      </div>
    );
    return (
...
// 点击二级导航，分组导航
  ...
  render() {
    ...
    let AddGroupContent = (
      <div>
        <Input placeholder="名称" ref="create_group_input" />
