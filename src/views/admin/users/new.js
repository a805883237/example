...
import {getUser, getusers, saveUser, updateUser} from '../../../reducers/actions/admin/users';
  ...
  render(){
    ...
    return (<Form horizontal form={this.props.form}>
      ...
      <FormItem {...formItemLayout} label="名称">
        <Input {...getFieldProps("user.name", requiredConf())} type="text" autoComplete="off"/>
      </FormItem>

      <FormItem {...formItemLayout} label="创建时间">
        <Input {...getFieldProps("user.created_at", requiredConf())} type="text" autoComplete="off"/>
      </FormItem>

      <FormItem {...formItemLayout} label="更新时间">
        <Input {...getFieldProps("user.updated_at", requiredConf())} type="text" autoComplete="off"/>
      </FormItem>
...
function formMapStateToProps(state) {
  return {
    itemData: state.admin_users.itemData
  };
}
//redux动作
