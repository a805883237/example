...
export function getImages(params) {
  return dispatch => {
    // let url=API_CONFIG.host + "/admin/images";
    let url="../../../data/images/index.json";
    //  ../三次，返回到manage/这一级
    return cFetch(url, {
      method: "GET",
      params: {id:1}
    }).then((response) => {
      dispatch(getImagesSuccess(response.jsonResult));
    })
  }
}
export function updateImage(rename, params) {
  // let url=API_CONFIG.host + "/admin/images/74";
  let url="../../../data/images/index.json";
  return (dispatch) => {
    return cFetch(url, {
      method: "PUT",
...
export function getGroups() {
  return dispatch => {
    // let url=API_CONFIG.host + "/admin/images";
    let url="../../../data/images/groups.json";
    return cFetch(url, {
      method: "GET",
      params: {}
    }).then((response) => {
      dispatch(getGroupsSuccess(response.jsonResult));
    })
  }
}
...
export function getImage(id) {
  return (dispatch) => {
    // let url=API_CONFIG.host + "/admin/images/74/edit";
    let url="../../data/images/index.json";
    return cFetch(url, {
      method: "GET",
      params: {}
    }).then((response) => {
      dispatch(getImageSuccess(response.jsonResult));
    });
  }
}
...
export function deleteImages(params) {
  // let url=API_CONFIG.host + "/admin/images/74/delete";
  let url="../../data/images/index.json";
  return (dispatch) => {
    return cFetch(API_CONFIG.host + "/admin/explore/pages/", {
      ...
      dispatch(deleteImagesSuccess(response.jsonResult));
    })
  }
}
