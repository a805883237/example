...
export default {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: `${__dirname}/dist/manage/index.html`,
  ...
  module: {
    loaders: [
      ...
      {test: /(\.css|\.scss|\.less)$/, include: path.join(__dirname, 'node_modules/antd'), loader: extractAntd.extract('css')},
      {test: /(\.css|\.scss|\.less)$/, include: path.join(__dirname, 'src'), loader: extractCss.extract('css!postcss!sass')}
    ]
  },
